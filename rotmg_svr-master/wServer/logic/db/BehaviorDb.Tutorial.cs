            ...
            .Init("Bonegrind the Butcher",
                    new State(
                        ...
                        new State("AttackX",
                            ...
                            new Prioritize(
                                new Follow(0.6, acquireRange: 9, range: 3),
                                new Wander(0.6)
                            ),
                        ...
                        new State("AttackY",
                            ...
                            new Sequence(
                                new Shoot(7, count: 4, fixedAngle: 25),
                                new Shoot(7, count: 4, fixedAngle: 50),
                                new Shoot(7, count: 4, fixedAngle: 75),
                                new Shoot(7, count: 4, fixedAngle: 100),
                                new Shoot(7, count: 4, fixedAngle: 125)
                            ),
