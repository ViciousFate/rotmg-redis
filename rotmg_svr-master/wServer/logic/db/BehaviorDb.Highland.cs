            ...
            .Init("Minotaur",
                    new State(
                        ...
                        new State("spam_blades",
                            ...
                            new Shoot(8, projectileIndex: 0, count: 3, predictive: 0.2, coolDown: 100000, coolDownOffset: 1600),
                            new Shoot(8, projectileIndex: 0, count: 1, shootAngle: 24, coolDown: 100000, coolDownOffset: 2200),
                            new Shoot(8, projectileIndex: 0, count: 2, predictive: 0.2, coolDown: 100000, coolDownOffset: 2800),
                            new Shoot(8, projectileIndex: 0, count: 3, shootAngle: 16, coolDown: 100000, coolDownOffset: 3200),
                            new Prioritize(
                                new StayAbove(0.6, 160),
                                new Wander(0.6)
                            ),
                        ...
                        new State("blade_ring",
                            new Shoot(7, fixedAngle: 0, count: 12, shootAngle: 30, coolDown: 800, projectileIndex: 1, coolDownOffset: 600),
                            new Shoot(7, fixedAngle: 15, count: 6, shootAngle: 60, coolDown: 800, projectileIndex: 2, coolDownOffset: 1000),
                            new Prioritize(
                                new StayAbove(0.6, 160),
                    ...
                    new State(
                        new State("circle_player",
                            ...
                            new Prioritize(
                                ...
                                new Protect(0.7, "Undead Dwarf King", acquireRange: 11, protectionRange: 10, reprotectRange: 3),
                        ...
                        new State("circle_king",
                            new Shoot(8, count: 5, shootAngle: 72, defaultAngle: 20, predictive: 0.3, coolDown: 1600, coolDownOffset: 500),
                            new Shoot(8, count: 5, shootAngle: 72, defaultAngle: 33, predictive: 0.3, coolDown: 1600, coolDownOffset: 1300),
                            new Prioritize(
                                new StayAbove(0.7, 160),
                                new Orbit(1.2, 2.5, target: "Undead Dwarf King", acquireRange: 12, radiusVariance: 0.1, speedVariance: 0.1),
                                new Wander(0.7)
                            ),
            ...
            .Init("Soulless Dwarf",
                    new State(
                        ...
                        new State("run1",
                            new Prioritize(
                                new StayAbove(0.4, 160),
                                new Protect(1.1, "Undead Dwarf God", acquireRange: 16, protectionRange: 10, reprotectRange: 1),
                                new Wander(0.4)
                            ),
                        ...
                        new State("run3",
                            new Prioritize(
                                ...
                                new Protect(1, "Undead Dwarf Axebearer", acquireRange: 16, protectionRange: 2, reprotectRange: 2),
                                new Protect(1, "Undead Dwarf Warrior", acquireRange: 16, protectionRange: 2, reprotectRange: 2),
                                new Wander(0.4)
                            ),
