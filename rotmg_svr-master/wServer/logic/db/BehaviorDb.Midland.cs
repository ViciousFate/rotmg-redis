        ...
        _ Midland = () => Behav()
            ...
            .Init("Orc Mage",
                    new State(
                        ...
                        new State("circle_queen",
                            ...
                            new Prioritize(
                                new StayAbove(1.4, 60),
                                new Orbit(1.2, 2.5, target: "Orc Queen", acquireRange: 12, speedVariance: 0.1, radiusVariance: 0.1)
                            ),
            ...
            .Init("Orc Warrior",
                    new State(
                        ...
                        new Prioritize(
                            new StayAbove(1.4, 60),
                            new Orbit(1.35, 2.5, target: "Orc Queen", acquireRange: 12, speedVariance: 0.1, radiusVariance: 0.1)
                        )
                    ),
                    new ItemLoot("Health Potion", 0.03)
                )
            ...
            .Init("Horned Drake",
                    new State(
                        ...
                        new State("protect_me",
                            ...
                            new State("three_shot",
                                new Shoot(8, count: 3, shootAngle: 40, predictive: 0.1, coolDown: 100000, coolDownOffset: 700),
