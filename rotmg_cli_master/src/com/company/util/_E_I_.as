...
package com.company.util{
    ...
    public class _E_I_ {
        ...
        public static function _1K_(_arg1:Rectangle, _arg2:Number, _arg3:Number):Number{
            ...
            return (PointUtil._R_O_(_local4, _local5, _arg2, _arg3));
        }
        public static function _05x(_arg1:Rectangle, _arg2:Number, _arg3:Number):Point{
            var _local4:Number = _arg2;
            var _local5:Number = _arg3;
            if (_local4 < _arg1.x)
            {
        ...
        public static function _N_o(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):Boolean{
            var _local8:Number;
            var _local9:Number;
            var _local10:Number;
            var _local11:Number;
        ...
        public static function _S_1(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Point):Boolean{
            var _local7:Number;
            var _local8:Number;
            var _local9:Number;
            var _local10:Number;
        ...
        public static function _0F_c(_arg1:Rectangle, _arg2:IntPoint, _arg3:IntPoint):Point{
            var _local4:Number;
            var _local5:Number;
            var _local6:Number;
            var _local7:Number;
        ...
        public static function _F_s(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):_1u{
            var _local9:Point;
            var _local11:int;
