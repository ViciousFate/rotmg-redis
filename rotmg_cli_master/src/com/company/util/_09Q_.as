...
package com.company.util{
    ...
    public class _09Q_ {
        ...
        public function _09Q_(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number){
            this.x0_ = _arg1;
            this.y0_ = _arg2;
            this.x1_ = _arg3;
            this.y1_ = _arg4;
        ...
        public static function _094(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number, _arg8:Number):Boolean{
        ...
        public static function _I_K_(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number, _arg8:Number, _arg9:Number, _arg10:Number):Boolean{
            ...
            return (((((_c6(_arg1, _arg2, _arg3, _arg4, _arg7, _arg8, _arg9, _arg10)) || (_c6(_arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10)))) || (_c6(_arg5, _arg6, _arg1, _arg2, _arg7, _arg8, _arg9, _arg10))));
        }
        private static function _c6(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number, _arg8:Number):Boolean{
            var _local11:Number;
            var _local12:Number;
            var _local13:Number;
            var _local14:Number;
        ...
        public function _7X_():Number{
            return (Math.abs(((((this.x0_ * (this.y1_ - this.y2_)) + (this.x1_ * (this.y2_ - this.y0_))) + (this.x2_ * (this.y0_ - this.y1_))) / 2)));
        }
        public function _1F_(_arg1:Point):void{
            var _local2:Number = PointUtil._R_O_(this.x1_, this.y1_, this.x2_, this.y2_);
            var _local3:Number = PointUtil._R_O_(this.x0_, this.y0_, this.x2_, this.y2_);
            var _local4:Number = PointUtil._R_O_(this.x0_, this.y0_, this.x1_, this.y1_);
        ...
        public function distance(_arg1:Number, _arg2:Number):Number{
            ...
            return (Math.min(_mz._K_Z_(_arg1, _arg2, this.x0_, this.y0_, this.x1_, this.y1_), _mz._K_Z_(_arg1, _arg2, this.x1_, this.y1_, this.x2_, this.y2_), _mz._K_Z_(_arg1, _arg2, this.x0_, this.y0_, this.x2_, this.y2_)));
        }
        public function _H_P_(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number):Boolean{
            return (_I_K_(this.x0_, this.y0_, this.x1_, this.y1_, this.x2_, this.y2_, _arg1, _arg2, _arg3, _arg4));
        }
