...
package com.company.assembleegameclient.objects{
    ...
    public class GameObject extends BasicObject {
        ...
        public function GameObject(_arg1:XML){
            ...
            {
                this._aY_ = (this._L_T_ = int(_arg1.MaxHitPoints));
            };
            if (_arg1.hasOwnProperty("Defense"))
            {
                this._ai = int(_arg1.Defense);
            };
            if (_arg1.hasOwnProperty("SlotTypes"))
            {
                this._9A_ = ConversionUtil._04n(_arg1.SlotTypes);
                this._zq = new Vector.<int>(this._9A_.length);
                _local4 = 0;
                while (_local4 < this._zq.length)
                {
                    this._zq[_local4] = -1;
                    _local4++;
                };
