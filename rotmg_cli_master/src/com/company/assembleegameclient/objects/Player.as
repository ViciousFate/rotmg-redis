...
package com.company.assembleegameclient.objects{
    ...
    public class Player extends Character {
        ...
        public var _a7:int = 200;
        public var _86:Number = 0;
        public var _7V_:int = 1000;
        public var exp_:int = 0;
        public var _hh:int = 0;
        public var speed_:int = 0;
        public var _gc:int = 0;
        public var _kO_:int = 0;
        public var _0F_f:int = 0;
        ...
        public static function _D_U_(_arg1:String, _arg2:XML):Player{
            ...
            _local5.name_ = _arg1;
            _local5._81 = int(_arg2.Level);
            _local5.exp_ = int(_arg2.Exp);
            _local5._zq = ConversionUtil._04n(_arg2.Equipment);
            _local5._L_T_ = int(_arg2.MaxHitPoints);
            _local5._aY_ = int(_arg2.HitPoints);
            _local5._a7 = int(_arg2.MaxMagicPoints);
            _local5._86 = int(_arg2.MagicPoints);
            _local5._hh = int(_arg2.Attack);
            _local5._ai = int(_arg2.Defense);
            _local5.speed_ = int(_arg2.Speed);
            _local5._gc = int(_arg2.Dexterity);
            _local5._kO_ = int(_arg2.HpRegen);
            _local5._0F_f = int(_arg2.MpRegen);
        ...
        override public function update(_arg1:int, _arg2:int):Boolean{
            ...
            if (this._D_k != null)
            {
                ...
                if (this._ky != 0)
                {
                    _local3 = (_local3 + ((_arg2 * Parameters.RotationSpeed) * this._ky));
            ...
            if ((((((((((map_.player_ == this)) && ((_0H_B_.props_.maxDamage_ > 0)))) && (((_0H_B_.lastDamage_ + 500) < _arg1)))) && (!(_0C_4())))) && ((((_0H_B_.obj_ == null)) || (!(_0H_B_.obj_.props_.protectFromGroundDamage_))))))
            {
                ...
                damage(-1, _local6, null, (_aY_ <= _local6), null);
        ...
        public function _F_W_():Number{
            ...
            var _local1:Number = (_lU_ + ((this._gc / 75) * (_Z_ - _lU_)));
            if (_L_8())
            {
                _local1 = (_local1 * 1.5);
            };
        ...
        private function _6D_():Number{
            ...
            var _local1:Number = (_01b + ((this._hh / 75) * (_0J_Q_ - _01b)));
            if (_07I_())
            {
                _local1 = (_local1 * 1.5);
            };
        ...
        override protected function getTexture(_arg1:_0D_v, _arg2:int):BitmapData{
            ...
            if (_local9 == null)
            {
                _local9 = TextureRedrawer.outlineGlow(_local8, 0, (((this._2v == -1)) ? 0 : 0xFF0000));
                _qm[_local8] = _local9;
            };
            if (((isPaused()) || (_C_H_())))
            {
        ...
        public function _lY_(_arg1:Number, _arg2:Number):void{
            var _local7:XML;
            var _local8:int;
            var _local10:Number;
        ...
        override public function toString():String{
            return ((((((((((((((((((((((((((((((((((((((((((((((("<Char>" + "<Name>") + name_) + "</Name>") + "<ObjectType>") + objectType_) + "</ObjectType>") + "<Level>") + _81) + "</Level>") + "<Exp>") + this.exp_) + "</Exp>") + "<Equipment>") + _zq) + "</Equipment>") + "<MaxHitPoints>") + _L_T_) + "</MaxHitPoints>") + "<HitPoints>") + _aY_) + "</HitPoints>") + "<MaxMagicPoints>") + this._a7) + "</MaxMagicPoints>") + "<MagicPoints>") + this._86) + "</MagicPoints>") + "<Attack>") + this._hh) + "</Attack>") + "<Defense>") + _ai) + "</Defense>") + "<Speed>") + this.speed_) + "</Speed>") + "<HpRegen>") + this._kO_) + "</HpRegen>") + "<MpRegen>") + this._0F_f) + "</MpRegen>") + "<Dexterity>") + this._gc) + "</Dexterity>") + "</Char>"));
        }
