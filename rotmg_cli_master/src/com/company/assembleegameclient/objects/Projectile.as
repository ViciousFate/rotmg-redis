...
package com.company.assembleegameclient.objects{
    ...
    public class Projectile extends BasicObject {
        ...
        override public function update(_arg1:int, _arg2:int):Boolean{
            ...
            if (_local6 != null)
            {
                ...
                } else
                {
                    ...
                    {
                        if (this.ownerId_ == map_.player_.objectId_)
                        {
                            _local7 = true;
                        };
                    };
                ...
                {
                    _local8 = GameObject._C_f(this.damage_, _local6._ai, this._ko._N_J_, _local6._9B_);
                    _local9 = false;
                    if (_local6._aY_ <= _local8)
                    {
                        _local9 = true;
                        if (_local6.props_.isEnemy_)
                        {
        ...
        public function _eA_(_arg1:Number, _arg2:Number):GameObject{
            ...
            for each (_local5 in map_.goDict_)
            {
                if (!_local5._0C_4())
                {
                    if (!_local5._C_H_())
                    {
                        if (((((this._jr) && (_local5.props_.isEnemy_))) || (((this._0H_n) && (_local5.props_._0E_4)))))
                        {
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:_0D_v, _arg3:int):void{
            ...
            if (this._ko._H_i)
            {
                map_.addObj(new _06s(100, 0xFF00FF, 600, 0.5, _04d._F_e(3), _04d._F_e(3)), x_, y_);
                map_.addObj(new _06s(100, 0xFF00FF, 600, 0.5, _04d._F_e(3), _04d._F_e(3)), x_, y_);
                map_.addObj(new _06s(100, 0xFF00FF, 600, 0.5, _04d._F_e(3), _04d._F_e(3)), x_, y_);
            };
        }
