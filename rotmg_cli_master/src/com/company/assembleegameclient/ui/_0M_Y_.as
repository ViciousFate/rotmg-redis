...
package com.company.assembleegameclient.ui{
    ...
    public class _0M_Y_ extends Sprite {
        ...
        public function _0M_Y_(_arg1:int, _arg2:int, _arg3:uint, _arg4:uint, _arg5:String=null){
            ...
            {
                this.labelText_ = new SimpleText(14, this._native, false, 0, 0, "Myriad Pro");
            ...
            this._08m = new SimpleText(14, 0xFFFFFF, false, 0, 0, "Myriad Pro");
            this._08m.setBold(true);
            this._08m.filters = [new DropShadowFilter(0, 0, 0)];
            this._08m.y = -3;
            this._0M_M_ = new SimpleText(14, this._native, false, 0, 0, "Myriad Pro");
            this._0M_M_.setBold(true);
            this._0M_M_.alpha = 0.6;
            this._0M_M_.y = -3;
            this._0M_M_.filters = [new DropShadowFilter(0, 0, 0)];
            this._5B_ = new SimpleText(14, 9493531, false, 0, 0, "Myriad Pro");
        ...
        private function _0E_J_():void{
            ...
            if (((this._68) && ((this.h_ > 4))))
            {
                if (this._05E_ > 0)
                {
                    this._08m.text = ((("" + this.val_) + "/") + this._05E_);
                } else
                {
