...
package com.company.assembleegameclient.ui{
    ...
    public class _E_6 extends Slot {
        ...
        public function _C_p():Boolean{
            ...
            return (((!((_local1 == null))) && ((_local1._86 < this._K_9))));
        }
        ...
        public function _0E_J_():void{
            ...
            if ((((this.objectType_ == -1)) || ((type_ == __get))))
            {
                this._cX_ = false;
            } else
            {
            ...
            this._X_B_ = new _061(this.objectType_, this);
        ...
        private function _X_6():void{
            ...
            var _local2:Boolean = ObjectLibrary._d1(this.objectType_, _local1);
        ...
        private function _i9():void{
            toolTip_ = new _aS_(0x363636, 0x9B9B9B, null, (("Empty " + this._5I_()) + " slot"), 200);
        }
