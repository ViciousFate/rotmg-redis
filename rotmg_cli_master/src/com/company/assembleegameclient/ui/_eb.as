...
package com.company.assembleegameclient.ui{
    ...
    public class _eb extends Sprite {
        ...
        private static const _xV_:Array = [[1, 0, 0, 1], _pm, _pm, [0, 1, 1, 0], [1, 0, 0, 0], _pm, _pm, [0, 1, 0, 0], [0, 0, 0, 1], _pm, _pm, [0, 0, 1, 0]];
        ...
        public function _eb(_arg1:GameSprite, _arg2:String, _arg3:Vector.<_35>, _arg4:Boolean){
            ...
            while (_local5 < _arg3.length)
            {
                ...
                _local7 = new _2j(_local6.item_, _local6._var, _local6.included_, _local6._01T_, (_local5 - 3), _xV_[_local5], _local5);
        ...
        private function onMouseOver(_arg1:Event):void{
            ...
            this._V_B_(new EquipmentToolTip(_local2.item_, this.gs_.map_.player_, -1, _U_c.OTHER_PLAYER, _local2.id));
        }
