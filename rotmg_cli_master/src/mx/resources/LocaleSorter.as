package mx.resources
{
   ...
   public class LocaleSorter extends Object
   {
      ...
      private static function normalizeLocale(param1:String) : String {
         return param1.toLowerCase().replace(new RegExp("-","g"),"_");
      }
...
class LocaleID extends Object
{
   ...
   public static function fromString(param1:String) : LocaleID {
      ...
      var _loc3_:int = STATE_PRIMARY_LANGUAGE;
      var _loc4_:Array = param1.replace(new RegExp("-","g"),"_").split("_");
      var _loc6_:* = 0;
      ...
      while(_loc6_ < _loc7_)
      {
         ...
         if(_loc3_ == STATE_PRIMARY_LANGUAGE)
         {
            ...
            else
            {
               if(_loc8_ == "i")
               {
                  _loc2_.lang = _loc2_.lang + "i-";
               }
               else
               {
                  _loc2_.lang = _loc2_.lang + _loc8_;
                  _loc3_ = STATE_EXTENDED_LANGUAGES;
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != 0)
            {
               ...
               {
                  if(_loc3_ <= STATE_SCRIPT && _loc9_ == 4)
                  {
                  ...
                  {
                     if(_loc3_ <= STATE_REGION && (_loc9_ == 2 || _loc9_ == 3))
                     {
                        _loc2_.region = _loc8_;
                        _loc3_ = STATE_VARIANTS;
                     }
                     else
                     {
                        if(_loc3_ <= STATE_VARIANTS && (_loc10_ >= "a" && _loc10_ <= "z" && _loc9_ >= 5 || _loc10_ >= "0" && _loc10_ <= "9" && _loc9_ >= 4))
                        {
                        ...
                        {
                           if(_loc3_ < STATE_PRIVATES && _loc9_ == 1)
                           {
                              if(_loc8_ == "x")
                              {
                                 _loc3_ = STATE_PRIVATES;
                                 _loc5_ = _loc2_.privates;
                              }
                              else
                              {
                                 _loc3_ = STATE_EXTENSIONS;
...
class LocaleRegistry extends Object
{
