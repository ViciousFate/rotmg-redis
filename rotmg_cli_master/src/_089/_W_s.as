...
package _089{
    ...
    public class _W_s {
        ...
        private static var _tb:int;
        private static var _C_E_:int;
        private static var _6L_:int;
        private static var _Z_n:int;
        private static var _0A_m:int;
        ...
        private static function _Z_R_(_arg1:int):Boolean{
            ...
            _tb = _P_D_.readUnsignedByte();
            _C_E_ = _P_D_.readUnsignedByte();
            _6L_ = _P_D_.readUnsignedByte();
            _Z_n = _P_D_.readUnsignedByte();
            _0A_m = _P_D_.readUnsignedByte();
            if ((((_I_U_ <= 0)) || ((_Q_L_ <= 0))))
            {
                return (false);
            };
