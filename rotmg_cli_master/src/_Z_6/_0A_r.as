...
package _Z_6{
    public class _0A_r {
        ...
        public function _0A_4():_uL_{
            ...
            {
                case "{":
                    _local1.type = _L_t._B_a;
                    _local1.value = "{";
                    this._0J_L_();
                    break;
                case "}":
                    _local1.type = _L_t._K_B_;
                    _local1.value = "}";
                    this._0J_L_();
                    break;
                case "[":
                    _local1.type = _L_t._0B_5;
                    _local1.value = "[";
                    this._0J_L_();
                    break;
                case "]":
                    _local1.type = _L_t._0M_B_;
                    _local1.value = "]";
                    this._0J_L_();
                    break;
                case ",":
                    _local1.type = _L_t._gX_;
                    _local1.value = ",";
                    this._0J_L_();
                    break;
                case ":":
                    _local1.type = _L_t._bT_;
                    _local1.value = ":";
                    this._0J_L_();
                    break;
                case "t":
